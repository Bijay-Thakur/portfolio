  ...
  return (
    <section id="education" className="py-24 px-4 max-w-4xl mx-auto">
      ...
      <div className="relative">
        {/* Vertical spine */}
        <div className="absolute left-5 top-0 bottom-0 w-px bg-gradient-to-b from-[rgba(13,214,200,0.5)] via-[rgba(13,214,200,0.15)] to-transparent" />
        ...
        <div className="space-y-10">
          {education.map((edu, i) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute left-[14px] top-3 w-3 h-3 rounded-full border-2 border-teal bg-ocean shadow-[0_0_8px_rgba(13,214,200,0.5)]" />
              ...
              <div className="bg-[rgba(13,214,200,0.03)] border border-[rgba(13,214,200,0.1)] rounded-lg p-5 hover:border-[rgba(13,214,200,0.28)] transition-colors">
                ...
                {/* Degree */}
                <p className="text-teal/80 text-sm font-medium mb-3 pl-5">{edu.degree}</p>

                {/* GPA + Honor row */}
                <div className="flex flex-wrap gap-2 pl-5 mb-3">
